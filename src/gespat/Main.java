...
public class Main {
	...
	public static void genData() throws ProcessingException {
		...
		try {
			consultationController.add(patientController.get(1), "Gérard", LocalDate.now(), pathologies1, device1, "Oh bah non il est mort...");

			consultationController.add(patientController.get(1), "Monique", LocalDate.of(2020, 1, 5), pathologies2, device2, "Oh le con.");

			consultationController.add(patientController.get(0), "Rodolphe", LocalDate.of(2000, 5, 22), pathologies3, device3, "Hate it.");
